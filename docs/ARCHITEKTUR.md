...
**UI**: `ConvertMenu` auf der Angebots-/AB-Seite bietet „Teilrechnung…"/„Abschlagsrechnung…"/„Schlussrechnung erzeugen"; die Rechnungsseite zeigt bei `FINAL` einen Abzugsblock (je Abschlag eine Zeile, danach fett der Restbetrag) und einen Bezug-Link zur Quelle.
